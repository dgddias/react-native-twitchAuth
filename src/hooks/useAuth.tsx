...
function AuthProvider({ children }: AuthProviderData) {
  ...
  async function signIn() {
    try {
      ...
      // REDIRECT_URI - create OAuth redirect URI using makeRedirectUri() with "useProxy" option set to true - from account expo
      ...
      if(type === 'success' && params.error !== 'access_denied'){
        ...
        (params.state !== STATE && Alert.alert('Invalid state value'));
        }
